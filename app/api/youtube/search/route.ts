    ...
    function processVideoRenderer(video: any) {
      ...
      results.push({
        ...
        description:
          ...
          `Tonton video "${title}" di AbilTube.`,
        channelTitle,
        channelId,
        channelAvatar,
...
export async function GET(req: NextRequest) {
  ...
  if (directVideoId) {
    const directResult = {
      ...
      description: `Watch this video directly on AbilTube player with real-time comments, share, and like controls.`,
        ...
        for (const item of srRes.value) {
          ...
          if (!seenIds.has(id)) {
            ...
            combinedResults.push({
              ...
              youtubeId: item.id,
              title: item.title,
              description: item.description || `Tonton "${item.title}" di AbilTube.`,
