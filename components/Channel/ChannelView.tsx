              ...
              <button
                ...
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({
                      title: channel.title,
                      text: `Check out ${channel.title} on AbilTube!`,
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-center min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-2 line-clamp-2">
                      {featuredVideo.description || 'Stream and learn directly on AbilTube with full SponsorBlock and DeArrow support.'}
                    </p>
              ...
              <div className="lg:col-span-2 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-line">
                    {channel.description || 'Welcome to the official AbilTube channel. Discover high-definition videos, insightful tutorials, and real-time live content.'}
                  </p>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in">
          <div className="relative w-full max-w-lg bg-white dark:bg-[#1f1f1f] rounded-2xl p-6 shadow-2xl border border-gray-200 dark:border-[#383838] max-h-[85vh] overflow-y-auto">
            ...
            <div className="mt-4 space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
              <p>{channel.description || 'Official AbilTube Creator channel.'}</p>
