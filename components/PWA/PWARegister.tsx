    ...
    if ('serviceWorker' in navigator) {
      window.addEventListener('load', () => {
        navigator.serviceWorker
          .register('/sw.js')
          .then((registration) => {
            console.log('AbilTube PWA ServiceWorker registered with scope:', registration.scope);
          })
          .catch((error) => {
            console.warn('AbilTube PWA ServiceWorker registration failed:', error);
          });
      });
    }
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h4 className="text-xs font-bold text-gray-900 dark:text-white truncate">Install AbilTube App</h4>
          ...
          <div className="bg-white dark:bg-[#1f1f1f] border border-gray-200 dark:border-[#383838] rounded-3xl max-w-md w-full p-6 shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-gray-100 dark:border-[#2d2d2d]">
              <div className="flex items-center gap-3">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/icon.svg" alt="AbilTube" className="w-10 h-10 rounded-2xl shadow-sm object-contain" />
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white text-base">Install AbilTube</h3>
            ...
            <div className="py-4 space-y-4">
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                Nikmati AbilTube seperti aplikasi native tanpa iklan dan tanpa boros kuota:
              </p>
              ...
              {isIOS ? (
                ...
                <div className="p-3.5 bg-gray-50 dark:bg-[#262626] border border-gray-200 dark:border-[#333] rounded-2xl space-y-2">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
                    Klik tombol <b>Install Sekarang</b> di bawah ini, atau buka menu browser (titik 3 di kanan atas) &gt; pilih <b>&quot;Install AbilTube&quot;</b> / <b>&quot;Tambahkan ke Layar Utama&quot;</b>.
                  </p>
                </div>
              )}
            </div>
