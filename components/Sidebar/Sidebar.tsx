    ...
    <>
      ...
      <div className="pt-3 px-1">
        <button
          ...
          className="w-full p-2.5 bg-gradient-to-r from-red-600/10 to-red-500/5 dark:from-red-600/20 dark:to-red-500/10 hover:from-red-600/20 hover:to-red-500/15 border border-red-500/20 dark:border-red-500/30 rounded-xl flex items-center justify-between gap-2 group transition-all text-left cursor-pointer"
        >
          ...
          <Download className="w-4 h-4 text-red-600 dark:text-red-400 shrink-0 group-hover:scale-110 transition-transform" />
        </button>
      </div>
      ...
      <div className="pt-4 px-3 text-[11px] text-gray-400 dark:text-gray-500 space-y-2 pb-16 md:pb-6">
        <p className="leading-relaxed">
          Terms &bull; Privacy &bull; Safety &bull; AbilTube
        </p>
        <p className="pt-1 text-gray-500 dark:text-gray-600 font-mono text-[10px]">
          &copy; 2026/2027 ASSHIDIQI606 FORUM GROUP
        </p>
      </div>
    </>
  );
      ...
      {!isSidebarOpen ? (
        ...
        <aside className="hidden md:flex flex-col items-center w-18 shrink-0 py-3 bg-white dark:bg-[#0f0f0f] border-r border-gray-200 dark:border-[#272727] select-none z-30 transition-all">
          {[
            ...
            { customIcon: ShortsIcon, label: 'Shorts', view: 'shorts' as PageView },
