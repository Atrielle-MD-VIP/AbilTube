...
export const WatchPage: React.FC = () => {
  ...
  const displayDescription = (liveDetails?.description && liveDetails.description !== 'Tonton video di AbilTube player.' && liveDetails.description !== 'Tonton video di NextTube player.') ? liveDetails.description : activeVideo.description;
    ...
    <div className="w-full max-w-[1920px] mx-auto p-3 sm:p-6 lg:px-8">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Video Title */}
          <h1
            className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mt-3 leading-snug"
