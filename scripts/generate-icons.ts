...
<svg width="600" height="200" viewBox="0 0 600 200" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="195" y="126" font-family="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="800" font-size="78" letter-spacing="-1.5">
    <tspan fill="#111111" class="dark-text">Abil</tspan><tspan fill="#FF1A38">Tube</tspan>
  </text>
</svg>
`;
...
async function generate() {
  ...
  await sharp(Buffer.from(fullLogoSvg))
    .png()
    .toFile(path.join(publicDir, 'abiltube-logo.png'));

  console.log('All PWA and AbilTube icons generated successfully!');
}
